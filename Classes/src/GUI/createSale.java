...
public class createSale extends JInternalFrame {
    ...
    public createSale() throws IOException, SQLException {
        //ArrayList<Item> shopping = new ArrayList<>();
        Map<Integer, Vector<Item>> shopping = new TreeMap<>();
        ...
        for(int i=1;i<100; i++){
            amount.add(Integer.toString(i));
        }
        SpinnerListModel amountList = new SpinnerListModel(amount);
        JSpinner spinner = new JSpinner(amountList);
        ...
        JComboBox<String> productCBox = new JComboBox<>(new String[]{});
        //Add available items to combo box
        for(Item anItemList: itemList) {
            productCBox.addItem(anItemList.getName()+", "+ Integer.toString(anItemList.getId()));
        }
        JLabel totalLable = new JLabel();
        JLabel cnameLable = new JLabel();
        JComboBox<String> ClientBox = new JComboBox<>(new String[]{});
        clientList = customerDB.selectAllClients();
        for(Client anClientList: clientList) {
            ClientBox.addItem(anClientList.getFirstName()+" "+ anClientList.getCustomerID());
        }
        ...
        spinner.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        totalDisplay.setText(Double.toString(sum)+ "$");
        //addButton.setBorder(null);
        //addButton.setBorderPainted(false);
        //addButton.setContentAreaFilled(false);
        addButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                // TODO: 16/09/2018 Make date wider AND check why shopping isnt filling up
                String idetail = (String)productCBox.getSelectedItem();
                Vector<String> data = new Vector<>();
                String[] s2 = idetail.split(", ");
                try {
                    Item currentItem = new Item();
                    currentItem = currentItem.selectItemID(Integer.parseInt(s2[1]));
                    if(currentItem.getCurrentQuantity() - Integer.parseInt((String)spinner.getValue()) < 0) {
                        JOptionPane.showMessageDialog(prompt, "Not enough items in stock\nPlease try again");
                    }
                    else {
                        int amount = (Integer.parseInt((String)spinner.getValue()));
                        currentItem.purchase(amount);
                        sum += currentItem.getCost()*amount;
                        totalDisplay.setText(Double.toString(sum)+"$");
                        if(shopping.containsKey(amount)){
                            shopping.get(amount).add(currentItem);
                        }
                        else{
                            shopping.put(amount,new Vector<Item>());
                            shopping.get(amount).add(currentItem);
                        }
                        data.add(Integer.toString(Integer.parseInt((String)spinner.getValue())));
        ...
        printButton.setText("Purchase");
        printButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                // printButtonActionPerformed(evt);
                String cdetail = (String)ClientBox.getSelectedItem();
                String[] s1 = cdetail.split(" ");
                try{
                    Client currentClient = customerDB.chooseClientByID(Integer.parseInt(s1[1]));
                    currentClient.makePurchase(shopping, totalDisplay.getText());

                    for(int i=jTable1.getRowCount()-1;i>=0;i--){
                        ((DefaultTableModel)jTable1.getModel()).removeRow(i);
                        //total display now shows 0 for new purchase
                    }
                    JOptionPane.showMessageDialog(prompt, "Successfully Purchased items!");
                    sum = 0;
                    totalDisplay.setText(Double.toString(sum));
                    shopping.clear();
        ...
        dateLable.setText("Date: "+ new Date());

        dateDisplay.setFont(new java.awt.Font("Tahoma", 0, 14));

        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                new Object [][] {},
                new String [] {"Quantity", "Name", "Code", "Price"}
        ));
        ...
        productCBox.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                // productCBoxPopupMenuWillBecomeInvisible(evt);
            }
                                        ...
                                        .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addGap(18, 18, 18)
                                                                .addComponent(totalDisplay, GroupLayout.PREFERRED_SIZE, 184, GroupLayout.PREFERRED_SIZE))
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                                        ...
                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                .addGap(69, 69, 69)
                                                                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                                                        .addComponent(spinner, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE)
                                                                                        ...
                                                                                        .addComponent(productCBox, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE)
                                                                                        .addComponent(ClientBox, GroupLayout.PREFERRED_SIZE, 146, GroupLayout.PREFERRED_SIZE)))
                                                                        .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                ...
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(dateDisplay, GroupLayout.PREFERRED_SIZE, 138, GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                        ...
                                                        .addComponent(dateDisplay, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(17, 17, 17)
                                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                        .addComponent(productCBox, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
                                ...
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        .addComponent(totalDisplay, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
